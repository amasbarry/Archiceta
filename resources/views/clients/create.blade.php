            ...
            <form action="{{ route('clients.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <select class="form-select @error('type_client') is-invalid @enderror" name="type_client" id="clientType" required>
                                ...
                                <option value="collectivite" {{ old('type_client') == 'collectivite' ? 'selected' : '' }}>Collectivité</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12" id="prenomGroup">
                        <div class="form-group">
                            <label>Prénom</label>
                            <input type="text" name="prenom" id="prenomInput" class="form-control @error('prenom') is-invalid @enderror" value="{{ old('prenom') }}">
                    ...
                    <input type="hidden" name="societe" value="{{ old('societe') }}">
