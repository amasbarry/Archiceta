                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="client_id" class="form-select @error('client_id') is-invalid @enderror" required>
                                @foreach($clients as $client)
                                    <option value="{{ $client->id }}" {{ old('client_id', $paiement->client_id) == $client->id ? 'selected' : '' }}>{{ $client->societe ?? $client->prenom . ' ' . $client->nom }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="projet_id" class="form-select @error('projet_id') is-invalid @enderror" required>
                                @foreach($projets as $projet)
                                    <option value="{{ $projet->id }}" {{ old('projet_id', $paiement->projet_id) == $projet->id ? 'selected' : '' }}>{{ $projet->titre }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date', $paiement->date) }}" required>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <select name="moyen_paiement" class="form-select @error('moyen_paiement') is-invalid @enderror" required>
                                ...
                                <option value="cheque" {{ old('moyen_paiement', $paiement->moyen_paiement) == 'cheque' ? 'selected' : '' }}>Chèque</option>
                                <option value="especes" {{ old('moyen_paiement', $paiement->moyen_paiement) == 'especes' ? 'selected' : '' }}>Espèces</option>
                                <option value="carte" {{ old('moyen_paiement', $paiement->moyen_paiement) == 'carte' ? 'selected' : '' }}>Carte</option>
                                <option value="autre" {{ old('moyen_paiement', $paiement->moyen_paiement) == 'autre' ? 'selected' : '' }}>Autre</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="reference_paiement" class="form-control @error('reference_paiement') is-invalid @enderror" value="{{ old('reference_paiement', $paiement->reference_paiement) }}">
